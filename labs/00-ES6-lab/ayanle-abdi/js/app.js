...
function displayPics(){
  ...
  /*
  Two Reasons: 
  1. ES6 is NOT fully supported. You'd have to use a browser extention, like Chrome's ScratchJS to see console errors for or Babel to compile to files down to ES5
  2. let and const are block scoped. If you declare let rando outside of the while loop, it would work.
  */
  console.log(viewed)
...
displayPics();
>>>>>>> 7a65d2c50428d93dff8cd2932c85a54488fee4d3
